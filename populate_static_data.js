...
function populateMapAndCoins() {
    ...
    for(let coin of DefaultCoins) {
        ...
        http.get({host: "api.coingecko.com", port: 80, path: `/api/v3/coins/${coinId}/market_chart/range?vs_currency=usd&from=${dayAgoUnixTimestamp}&to=${curUnixTimestamp}`}, function (res) {
            console.log("Got response: " + res.statusCode);
